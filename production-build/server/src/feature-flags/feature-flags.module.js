...
const feature_flags_repository_1 = require("./feature-flags.repository");
...
exports.FeatureFlagsModule = FeatureFlagsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [feature_flags_service_1.FeatureFlagsService, feature_flags_repository_1.FeatureFlagsRepository],
        exports: [feature_flags_service_1.FeatureFlagsService, feature_flags_repository_1.FeatureFlagsRepository],
    })
], FeatureFlagsModule);
