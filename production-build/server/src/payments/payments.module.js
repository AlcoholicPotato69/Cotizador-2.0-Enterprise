...
const payment_allocation_listener_1 = require("./payment-allocation.listener");
...
exports.PaymentsModule = PaymentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            payment_allocation_listener_1.PaymentAllocationListener
        ],
        exports: [payments_service_1.PaymentsService, payments_repository_1.PaymentsRepository, payment_evidences_repository_1.PaymentEvidencesRepository],
    })
], PaymentsModule);
