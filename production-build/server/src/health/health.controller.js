...
let HealthController = class HealthController {
    ...
    async getMetrics(user, limit) {
        return this.service.getMetricsByTenant(user.tenantId, limit ? Number(limit) : 50);
    }
};
exports.HealthController = HealthController;
__decorate([
    (0, common_1.Get)(),
    (0, require_permissions_decorator_1.RequirePermissions)('health:read'),
    (0, permissions_decorator_1.Permissions)('health:read'),
...
__decorate([
    ...
    (0, require_permissions_decorator_1.RequirePermissions)('health:metrics'),
    (0, permissions_decorator_1.Permissions)('health:read'),
