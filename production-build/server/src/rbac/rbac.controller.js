...
__decorate([
    (0, common_1.Post)(),
    (0, require_permissions_decorator_1.RequirePermissions)('rbac.manage'),
    (0, permissions_decorator_1.Permissions)('rbac:write'),
...
__decorate([
    (0, common_1.Get)(),
    (0, require_permissions_decorator_1.RequirePermissions)('rbac.read'),
    (0, permissions_decorator_1.Permissions)('rbac:read'),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, require_permissions_decorator_1.RequirePermissions)('rbac.manage'),
    (0, permissions_decorator_1.Permissions)('rbac:delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
