...
let OccupancyController = class OccupancyController {
    ...
    async create(req, data) {
        return tenant_context_1.tenantContext.run({ tenantId: req.user.tenantId, userId: req.user.id, role: req.user.role }, () => this.occupancyService.createOccupancy(data));
    }
};
exports.OccupancyController = OccupancyController;
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('occupancy:write'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OccupancyController.prototype, "create", null);
