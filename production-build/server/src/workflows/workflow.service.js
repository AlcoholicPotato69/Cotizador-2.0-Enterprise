...
let WorkflowEngineService = class WorkflowEngineService {
    ...
    async executeTransition(tenantId, workflowVersionId, currentStateId, actionName, contextPayload) {
        ...
        if (!transition) {
            throw new common_1.BadRequestException(`Acción ${actionName} no válida para el estado actual.`);
        }
