...
exports.SignaturesModule = SignaturesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [signatures_repository_1.SignaturesRepository, signatures_service_1.SignaturesService],
        exports: [signatures_repository_1.SignaturesRepository, signatures_service_1.SignaturesService],
    })
], SignaturesModule);
