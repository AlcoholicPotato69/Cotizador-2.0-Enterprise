...
const quotes_listener_1 = require("./quotes.listener");
...
exports.QuotesModule = QuotesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [quotes_repository_1.QuotesRepository, quotes_service_1.QuotesService, quotes_listener_1.QuotesListener],
        exports: [quotes_repository_1.QuotesRepository, quotes_service_1.QuotesService],
    })
], QuotesModule);
