...
export function TenantsDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <BaseBreadcrumb items={[{ label: 'Tenants' }]} className="mb-6" />
      <div className="flex justify-between items-end mb-6">
        <div>
          <h1 className="text-2xl font-bold text-text-primary tracking-tight">Gestión de Tenants</h1>
          <p className="text-sm text-text-secondary mt-1">Administración de instancias y Multi-Tenant.</p>
        </div>
